...
import { cva as labelCva } from 'class-variance-authority';

const labelVariants = labelCva('text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70');
